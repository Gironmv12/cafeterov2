...
<body>
    ...
    <section class="media">
        <img class="media1" src="../images/instagram-post.jpg" alt="instagram-post">
    </section>

    <section class="media-2">
        <img class="media2" src="../images/twitter-post.jpg" alt="instagram-post">
        <img class="media3" src="../images/twitter-post.jpg" alt="instagram-post">
        <img class="media4" src="../images/twitter-post.jpg" alt="instagram-post">
        <img class="media5" src="../images/twitter-post.jpg" alt="instagram-post">
    </section>
    ...
    <sidebar class="sidebar-2">
        ...
        <p id="text-t">Tenemos un apartado especial para nuestros clientes que <br> han estado con nosotros grano a
            grano.</p>
        ...
        <div class="card-1">
            <div class="frame">
                <img src="../images/Avatar-Giron.png" alt="Imagen de Efraín" class="profile-img">
            </div>
            <div class="card-content">
                <p id="name">Efraín Morales</p>
                <p id="info">¡Hola!, me llamo Efraín y mi ca fé favorito es el café Chiapaneco</p>
