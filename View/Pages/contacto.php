...
<body>
    ...
    <nav>
        <div id="navbar">
            <p id="saludo">Reseñas</p>
            <p id="texto">Algunos de nuestros usuarios dijeron</p>
            <p id="text-s">Un espacio con la comunidad</p>
        </div>
    </nav>
    ...
    <sidebar class="sidebar-2">
        ...
        <p id="text-t">Comunícate con nuestro equipo de soporte <br><br> Ellos te ayudarán y guiarán en cualquier duda que tengas </p>

        <div class="card">
            <div class="frame">
                <img src="../images/Avatar-Oliver.png   " alt="Imagen de Efraín" class="profile-img">
            </div>
            <div class="card-content">
                <p id="name">¡Hola!</p>
                <p id="info">Me llamo Oliver y estoy dispuesto a ayudarte</p>
                <p id="email">cafetero@gmail.com</p>
            </div>
        </div>

        <div class="card-1">
            <div class="frame">
                <img src="../images/Avatar-Gamaliel.png" alt="Imagen de Efraín" class="profile-img">
            </div>
            <div class="card-content">
                <p id="name">¡Hola!</p>
                <p id="info">¡Me llamo Gamaliel y estoy dispuesto a ayudarte</p>
                <p id="email2">cafetero@gmail.com</p>
            </div>
        </div>

        <div class="card-2">
            <div class="frame">
                <img src="../images/Avatar-Efrain.png" alt="Imagen de Efraín" class="profile-img">
            </div>
            <div class="card-content">
                <p id="name">¡Hola!</p>
                <p id="info">¡Me llamo Efraín y estoy dispuesto a ayudarte</p>
                <p id="email3">cafetero@gmail.com</p>
            </div>
        </div>
        ...
        <section>
            <p id="text-q">Síguenos en nuestras redes sociales</p>
            <hr id="hr">
            <p id="text-c">!Tu opinion es importante para nosotros!</p>
        </section>

        <div class="image">
            <img src="../images/Giron-programmer.png" alt="Saludo-Giron">
        </div>
